...
<body>
<div id="login-form">
<h2 style ="color:tomato; text-align: center;">   होटल अडृा Admin</h2>
<input type="radio" checked id="login" name="switch" class="hide">
<input type="radio" id="signup" name="switch" class="hide">

<div>
<ul class="form-header">
<li style="margin-left: 65px;"><label for="login"><i class="fa fa-lock"></i> LOGIN<label for="login"></li>
...
<form action="addalogin.php" method="post">
<ul class="ul-list">
