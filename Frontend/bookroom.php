...
<body>
  ...
  <form action="bookedroom.php" action="GET">
    ...
    <div class="wrapper" style="background-color:burlywood;height: 1280px;">
      ...
      <div>
        <div style="background-color:white;width: 350px; padding: 20px;height:auto; border-radius:12px;">

           <br><br><br><br><br><br><br><br><br> 
          <h6 style="color:#1A5276 ;"> Please Fill Up the Information Below For</h6>
          ...
          ?>
            ...
            <h4 style="color:#D35400"><?php echo $row['hotelname'];
                                    } ?> </h4>
            <div class="form-group">
              <input type="hidden" value="<?php echo $id; ?>" name="hotelid">
              <label for="exampleInputEmail1">Full Name</label>
              <input type="text" name="fullname" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter full name" required>
      ...
      if (isset($_GET['city']) && isset($_GET['room'])) {
      ?>
        <div class="tm-article-carousel" id="result" style="margin-top:-200px; margin-left:80px;">
          <h3 style="color:brown;">RECOMMENDED HOTELS</h3>
          <?php
          $id = $_GET['id'];
          $city = $_GET['city'];
          $room = $_GET['room'];
          $sql14 = "SELECT *FROM hotel where location like '%$city%' and  hotel_total_rooms >='$room' and hotel_id != $id LIMIT 2";
          ...
          ?>
            <article class="tm-bg-white mr-2 tm-carousel-item">
              ...
              <div class="tm-article-pad">
                <header>
                  <h3 class="text-uppercase tm-article-title-2"><?php echo $row['hotelname']; ?></h3>
                </header>
