...
<div id="login-form">
<h2 style ="color:tomato; text-align: center;"> Become  होटल अडृा</h2>
...
{?>
 <h3 style="color:red;"> <?php   echo $_GET['errormsg']; ?> </h3>
<?php 
...
<form action="propertylogin.php" method="GET">
<ul class="ul-list">
<li><input type="email" required class="input" name="email" placeholder="Your Email"/><span class="icon"><i class="fa fa-user"></i></span></li>
<li><input type="password" required class="input" name="password" placeholder="Password"/><span class="icon"><i class="fa fa-lock"></i></span></li>
...
<div class="login">
<form action="propertysignup.php" method="GET">
<?php 
...
<li><input type="text" name="address" required class="input" placeholder="Your address"/><span class="icon"><i class="fa fa-user"></i></span></li>
<li><input type="number" name="phone" required class="input" placeholder="Your phone"/><span class="icon"><i class="fa fa-user"></i></span></li>

<li><input type="email" name="email" required class="input" placeholder="Your Email"/><span class="icon"><i class="fa fa-user"></i></span></li>
